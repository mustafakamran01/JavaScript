...
/* 
    If the given vaue is present then it will give the index value but, 
    if the given value is not present then it will give -1
*/ 
...
let myn1 = arr.slice(0,4);
console.log("Array after slicing: ", myn1);

console.log("Original array: ", arr);

let myn2 = arr.splice(0,4);
console.log("Array after splicing", myn2);
